...
def plot_error_distribution_by_circuit_depth(df, ieee_format=True):
    """
...
def plot_error_rate_vs_payload_size(df, ieee_format=True):
    """
...
def analyze_target_depth_experiment(csv_file_path):
    ...
    plot_error_distribution_by_circuit_depth(df, ieee_format=True)
    ...
    plot_error_rate_vs_payload_size(df, ieee_format=True)
