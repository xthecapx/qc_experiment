...
\begin{flushleft}
{\Large
\textbf\newline{Quantum Computers Benchmark Through Teleportation Protocol} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
% Insert author names, affiliations and corresponding author email (do not include titles, positions, or degrees).
\\
Cristian Marquez\textsuperscript{1},
Daniel Sierra-Sosa\textsuperscript{2*},
Kelly Garces\textsuperscript{1},
